  ...
  return (
    ...
    <View style={tw`bg-white px-[4%] py-2`}>
      <View style={tw` gap-3  flex-row justify-center items-center`}>
        <Text style={tw`text-2xl text-Primary900 font-NunitoSansExtraBold`}>Discover</Text>
      ...
      <Text style={tw`text-color-Black600 font-NunitoSansRegular text-text14 py-2`}>By following you can see their posts and shops & more..</Text>
    </View>
    <View style={tw`mt-2`}/>
    <FlatList
            ...
            //   onPress={() => navigation?.navigate('Message')}
              ...
              Component={
                <TouchableOpacity activeOpacity={0.5}>
                  <Text style={tw`text-color-Black800 font-NunitoSansMedium ${item.action === "Following" ? "text-primary" :""}`}>{item.action}</Text>
                </TouchableOpacity>
              }
            />
          </>
