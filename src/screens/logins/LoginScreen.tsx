...
const LoginScreen = ({navigation} : NavigProps<null>) => {
  ...
  <View style={tw`px-[4%] mt-12 gap-4`}>
         ...
         <View
          ...
          <path d="M0 2C0 1.17157 0.671573 0.5 1.5 0.5H13.5C14.3284 0.5 15 1.17157 15 2V3.20758L7.50001 7.42632L0 3.20757V2Z" fill="#454545"/>
           <path d="M0 4.35491V12C0 12.8284 0.671573 13.5 1.5 13.5H13.5C14.3284 13.5 15 12.8284 15 12V4.35493L7.50001 8.57367L0 4.35491Z" fill="#454545"/>
           </svg>
           `}
            />
          ...
          <View
            ...
            <SvgXml
              xml={`<svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11 11.5H10V10.5H11V11.5Z" fill="#454545"/>
                <path d="M8 11.5H9V10.5H8V11.5Z" fill="#454545"/>
                <path d="M13 11.5H12V10.5H13V11.5Z" fill="#454545"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M3 6.5V4C3 2.067 4.567 0.5 6.5 0.5C8.433 0.5 10 2.067 10 4V6.5H11.5C12.3284 6.5 13 7.17157 13 8V8.55001C14.1411 8.78164 15 9.79052 15 11C15 12.2095 14.1411 13.2184 13 13.45V14C13 14.8284 12.3284 15.5 11.5 15.5H1.5C0.671573 15.5 0 14.8284 0 14V8C0 7.17157 0.671573 6.5 1.5 6.5H3ZM4 4C4 2.61929 5.11929 1.5 6.5 1.5C7.88071 1.5 9 2.61929 9 4V6.5H4V4ZM8.5 9.5C7.67157 9.5 7 10.1716 7 11C7 11.8284 7.67157 12.5 8.5 12.5H12.5C13.3284 12.5 14 11.8284 14 11C14 10.1716 13.3284 9.5 12.5 9.5H8.5Z" fill="#454545"/>
                </svg>
                `}
                />
            <TextField
